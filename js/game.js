...
<div id="settingContent">
   // <button id="closeBtn" class="close-btn">X</button> <!-- Kapatma butonu -->
    ...
    function _0xce1bba() {
      $("#mm-event-text").replaceWith("<div class=\"text-vnxx\"><a href=\"https://www.wormate.io\">ğŸ… WSC 2025</a></div>");
  ...
  $(document).ready(function () {
    $("#background-canvas").replaceWith(`
      <canvas id="background-canvas" style="
        ...
        top: 0;
        left: 0;
        background: url('https://wallpapers.com/images/featured-full/1920-x-1080-hd-1qq8r4pnn8cmcew4.jpg') no-repeat center center;
